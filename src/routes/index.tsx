...
const faqs = [
  { q: "What is WorkPilot AI?", a: "WorkPilot AI is an AI-powered workplace assistant that automates emails, meeting summaries, task planning, research, and workplace conversations — all in one place." },
    ...
    <div className="min-h-screen bg-background text-foreground">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.2 }} className="relative">
            <div className="relative rounded-3xl border border-border bg-card/70 backdrop-blur-xl p-6 shadow-2xl" style={{ boxShadow: "var(--shadow-glow)" }}>
              <div className="flex items-center gap-2 pb-4 border-b border-border">
                ...
                <div className="ml-3 text-xs text-muted-foreground">workpilot.ai/chat</div>
              </div>
      ...
      <section className="max-w-5xl mx-auto px-5 lg:px-8 py-20">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-4">
          {[
            ...
            { icon: BrainCircuit, title: "AI Processing", desc: "WorkPilot routes your request to the best model." },
      ...
      <section className="max-w-7xl mx-auto px-5 lg:px-8 py-20">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-5">
          {[
            { name: "Sarah Chen", role: "Engineering Manager", company: "Acme Robotics", quote: "WorkPilot saves my team 10+ hours every week. The meeting summarizer alone is worth it." },
            ...
            { name: "Aisha Mensah", role: "Research Lead", company: "GreenGrid", quote: "I research engineering standards daily. WorkPilot summarizes ISO docs in seconds. Brilliant." },
          ].map((t) => (
